...
<td><input class="form-control" type="text"  name="USERID" value="<?php echo $dongtk['USERID']?>"style="padding-right:30px" disabled></td>
</tr>
<tr>
    <td style="text-align:center">Hiện Trạng</td>
     <td><input class="form-control" type="text" name="enable" value="<?php echo $dongtk['enable']?>" style="padding-right:30px"></td>
</tr>
<tr>
    
    <td colspan="2"><input class="btn btn-success" type="submit" name="suataikhoan" value="Sửa tài Khoản"></td>
</tr>
<?php
    }
    ?>
