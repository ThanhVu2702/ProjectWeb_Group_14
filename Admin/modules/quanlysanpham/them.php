...
<table border="1" width="90%" style="border-collapse: collapse; border:5px solid coral">
    <form method="POST" action="modules/quanlysanpham/xuly.php" enctype="multipart/form-data">
        ...
        <tr>
            ...
            <td><input class="form-control" type="file" name="hinhanh" style="width:100%;"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2"><input class="form-control" type="submit" name="themsanpham" value="Thêm" style="background-color:coral;border-radius:12px;border-style:dotted"></td>
        </tr>
    </form>
</table>