...
<td><input class="form-control"  class="form-control" type="file" name="hinhanh" style="width:100%;">
...
<td><textarea class="form-control" row="10" width="100%" name="noidung"   style="resize:none"><?php echo $row['noidung']?></textarea></td>
</tr>
<tr>
<td style="text-align:left;font-weight:bold;font-style:italic;color:coral">Tóm Tắt:</td>
<td><textarea row="10" class="form-control" width="100%" name="tomtat"   style="resize:none"><?php echo $row['tomtat']?></textarea></td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="2"><input class="form-control" type="submit" name="suasanpham" value="Sửa" style="background-color:coral;border-radius:12px;border-style:dotted"></td>
</tr>
</form>
<?php 
}
