...
<table class="table" style="" border="1",style="border-collapse:collapse">
<tr>
     <th>Id</th>
    <th>Tên Sản Phẩm</th>
    <th>Mã Sản Phẩm</th>
...
<td><?php echo $i?></td>
    ...
    ?></td>
    <td class="d-flex border-0" ><a class="btn btn-danger" href="modules/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham']?>">Xóa</a>|<a class="btn btn-success" href="?action=quanlysanpham&query=sua&id_sanpham=<?php echo $row['id_sanpham']?>">Sửa</a></td>
