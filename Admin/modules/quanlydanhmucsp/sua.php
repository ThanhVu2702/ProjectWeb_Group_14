...
<td><input class="form-control"  type="text" name="tendanhmuc" value="<?php echo $dong['tendanhmuc']?>"style="padding-right:30px"></td>
</tr>
<tr>
    <td style="text-align:center">Thứ Tự</td>
     <td><input class="form-control" type="text" name="thutu" value="<?php echo $dong['thutu']?>" style="padding-right:30px"></td>
</tr>
<tr>
    
    <td colspan="2"><input type="submit" class="btn btn-success" name="suadanhmuc" value="Sửa danh mục sản phẩm"></td>
</tr>
<?php
    }
    ?>
