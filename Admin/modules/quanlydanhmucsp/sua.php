...
<td><input type="text" name="tendanhmuc" class="form-control" value="<?php echo $dong['tendanhmuc']?>"style="padding-right:30px"></td>
</tr>
<tr>
...
<tr>
    ...
    <td colspan="2"><input class="form-control" type="submit" name="suadanhmuc" value="Sửa danh mục sản phẩm"></td>
</tr>
<?php
    }
    ?>
