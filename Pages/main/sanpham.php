                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        -->
                                        <div class="p-size">
                                            <h4>Size:</h4>
                                            <select name="size" class="btn-group btn-group-sm">
                                                <option value="S" class="btn">S</option>
                                                <option value= "M" class="btn">M</option>
                                                <option value="L" class="btn">L</option>
                                                <option value="XL" class="btn">XL</option>
                                            </select> 
                                        </div>
                                        <div class="p-color">
                                            <h4>Color:</h4>
                                            <select name="color" class="btn-group btn-group-sm">
                                                <option value="white" class="btn">White</option>
                                                <option value="Black" class="btn">Black</option>
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="sidebar-widget category">
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="fa fa-phone"></i>Fashion & Beauty</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="fa fa-phone"></i>Kids & Babies Clothes</a>
                                    </li>
                                    <li class="nav-item">
