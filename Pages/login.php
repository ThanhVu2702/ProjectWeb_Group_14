                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data == 'success-user') {
								window.location.href = "http://localhost/DoAnWeb2-main%20(1)/DoAnWeb2-main/index.php";
                            } else if (data == '') {
                               $('.username-error').html('Account don\'t exitst. Please enter create account').addClass('text-danger');
                             
                            } else if (data == 'success-admin') {
                                window.location.href = 'http://localhost/DoAnWeb2-main%20(1)/DoAnWeb2-main/Admin/index.php';
